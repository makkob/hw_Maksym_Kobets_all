...
// EXTERNAL MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??ruleSet[1].rules[1].use[1]!./node_modules/css-loader/dist/cjs.js!./src/css/common.css
...
var update = injectStylesIntoStyleTag_default()((common_default()), options);




       /* harmony default export */ const css_common = ((common_default()) && (common_default()).locals ? (common_default()).locals : undefined);

// EXTERNAL MODULE: ./src/templates/galleryTemplates.handlebars
var galleryTemplates_handlebars = __webpack_require__(734);
var galleryTemplates_handlebars_default = /*#__PURE__*/__webpack_require__.n(galleryTemplates_handlebars);
// EXTERNAL MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??ruleSet[1].rules[1].use[1]!./node_modules/css-loader/dist/cjs.js!./node_modules/material-icons/iconfont/material-icons.css
var material_icons = __webpack_require__(73);
var material_icons_default = /*#__PURE__*/__webpack_require__.n(material_icons);
;// CONCATENATED MODULE: ./node_modules/material-icons/iconfont/material-icons.css
...
var material_icons_options = {};

material_icons_options.styleTagTransform = (styleTagTransform_default());
material_icons_options.setAttributes = (setAttributesWithoutAttributes_default());

      material_icons_options.insert = insertBySelector_default().bind(null, "head");
    
material_icons_options.domAPI = (styleDomAPI_default());
material_icons_options.insertStyleElement = (insertStyleElement_default());

var material_icons_update = injectStylesIntoStyleTag_default()((material_icons_default()), material_icons_options);




       /* harmony default export */ const iconfont_material_icons = ((material_icons_default()) && (material_icons_default()).locals ? (material_icons_default()).locals : undefined);
...
var basicLightbox = __webpack_require__(27);
...
var Gallery = /*#__PURE__*/function () {
  function Gallery(URI, refs) {
    var _this = this;

    _classCallCheck(this, Gallery);

    _defineProperty(this, "init", function () {
      _this.refs.input.addEventListener("input", _.debounce(_this.getInput, 800));

      _this.fetchIMG();

      _this.refs.ul.addEventListener("click", _this.onGalleryClick);
    });

    _defineProperty(this, "getInput", function () {
      _this.refs.ul.innerHTML = "";
      var findIMG = _this.refs.input.value;
      var searchReq = "&q=".concat(findIMG);

      _this.fetchIMG(searchReq);
    });
    ...
    _defineProperty(this, "loadMore", function () {
      ...
      if (!!window.IntersectionObserver) {
        var observer = new IntersectionObserver(_this.onObserve, options);
        document.querySelectorAll("#next").forEach(function (ul) {
          observer.observe(ul);
        });
      } else {
    ...
    _defineProperty(this, "onObserve", function (entries, observer) {
      entries.forEach(function (entry) {
        if (entry.isIntersecting) {
          var nextPage = " &page=".concat(_this.pageNumber += 1);
          var findIMG = _this.refs.input.value;
          var searchReq = "&q=".concat(findIMG);

          _this.fetchIMG(searchReq, nextPage);
    ...
    _defineProperty(this, "displayModal", function (src) {
      console.log("test");
      var instance = basicLightbox.create("\n    <div class=\"modal\">\n    <img class=\"gallery-item-modal\" src=\"".concat(src, "\" width=\"800\" height=\"600\">\n    </div>\n"));
      instance.show();
    });

    _defineProperty(this, "onGalleryClick", function (event) {
      if (event.target.nodeName !== "IMG") {
        return;
      }

      _this.displayModal(event.target.dataset.src);
    });
  ...
  _createClass(Gallery, [{
    key: "fetchIMG",
    value: function () {
      var _fetchIMG = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(searchReq, nextPage) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return fetch(this.URI + searchReq + nextPage);
              ...
              case 6:
                ...
                (0,PNotify.alert)({
                  title: "Ready",
                  text: "".concat(data.total, " results found!"),
                  hide: true,
                  delay: 500
                });
                markup = galleryTemplates_handlebars_default()(data.hits);
...
var API_KEY = "28517920-47e926602853ad98d512bf5fa";
var URI = "https://pixabay.com/api/?image_type=photo&orientation=horizontal&per_page=12&key=".concat(API_KEY);
var gallery = new Gallery(URI, refs);
gallery.init();
})();
